...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Pablo Emmanuel\Documents\Pablo's Code\Python\Chunk_file_team_48'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Pablo Emmanuel\Documents\Pablo's Code\Python\Chunk_file_team_48\Scripts\deactivate.nu'
